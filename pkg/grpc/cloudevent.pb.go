...
type CloudEventHeader struct {
	...
	Extras map[string][]byte `protobuf:"bytes,11,rep,name=extras,proto3" json:"extras,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_pkg_grpc_cloudevent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_grpc_cloudevent_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_grpc_cloudevent_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CloudEventHeader); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
